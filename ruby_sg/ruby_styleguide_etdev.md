...
This is my personal version of the [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide), where I've removed things that I feel I've already internalized so that I can focus on the things I still need to learn.  I will continue to delete things as I get more comfortable with the language, so I wouldn't suggest using this document as a reference.
